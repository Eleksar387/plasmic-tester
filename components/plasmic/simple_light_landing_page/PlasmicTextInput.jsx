...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: z_bCDplD_j4sTZ/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: LnmyANvj7ppPw0/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: KAcn-iaE8-GUag/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__ucCz5)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___2F6PD)}
                role={"img"}
              />
            ),
