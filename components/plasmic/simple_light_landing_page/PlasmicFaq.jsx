...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: j3KsG080xcLwaw/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__rGlga)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__zbvd)}>
          <div className={classNames(projectcss.all, sty.freeBox___7TsGl)}>
            {p.renderPlasmicSlot({
